"""API client for NVIDIA NeMo AI training framework."""
...
short_description: REST API client for NVIDIA NeMo AI training framework
description:
...
class NvidiaApiClient:
    """REST client for NVIDIA NeMo AI training framework."""
