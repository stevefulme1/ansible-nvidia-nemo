"""Common argument specs and constants for NVIDIA NeMo AI training framework."""
...
short_description: Shared argument specs and constants for NVIDIA NeMo AI training framework
description:
...
NVIDIA_COMMON_ARGS = dict(
    api_url=dict(type="str", default="https://api.nemo.nvidia.com"),
