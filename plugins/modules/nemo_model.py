...
"""Ansible module for manage nemo models."""
...
---
module: nemo_model
short_description: Manage NeMo models
description:
    - Manage NeMo models using the NVIDIA REST API.
...
EXAMPLES = r"""
- name: Create a model
  stevefulme1.nvidia_nemo.nemo_model:
    name: "example-name"
    state: present
