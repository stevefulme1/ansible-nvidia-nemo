"""Shared pytest fixtures for nvidia_nemo collection unit tests."""
...
try:
    import ansible_collections.stevefulme1.nvidia_nemo  # noqa: F401
    ...
    _coll_mod = types.ModuleType("ansible_collections.stevefulme1.nvidia_nemo")
    _coll_mod.__path__ = [_collection_root]
    _coll_mod.__package__ = "ansible_collections.stevefulme1.nvidia_nemo"
    sys.modules["ansible_collections.stevefulme1.nvidia_nemo"] = _coll_mod
...
def module_args():
    ...
    return {
        "api_url": "https://api.nemo.nvidia.com",
